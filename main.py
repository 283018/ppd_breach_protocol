...
def main():
    ...
    print("\n    Gurobi: ")
    solution_print(example_gb[0], example_gb[1])
    print("\n    Brute: ")
    solution_print(example_bf[0], example_bf[1])
    ...
    solution_1, time_1 = gb_solver(task)
    solution_2, time_2 = bf_solver(task)
    solution_print(task, solution_1, True)
    solution_print(task, solution_2, True)
    print("   gurobi | brute")
